    ...
    <div className="min-h-screen flex">
      <div className="hidden lg:flex lg:w-1/2 relative overflow-hidden bg-card items-center justify-center p-12">
        ...
        >
          ...
          <p className="text-secondary-text leading-relaxed">
            Create your free account and get instant access to AI-powered document analysis, trust scores, and Lexi assistant.
          </p>
        </motion.div>
      </div>
      ...
      <div className="flex-1 flex items-center justify-center p-6 sm:p-12">
        ...
        >
          ...
          <Button variant="outline" className="w-full mb-6" onClick={handleGoogleSignup} type="button">
